				...
				<div class="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-60 lg:px-8 lg:pt-32">
					<div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
						<div class="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
							...
							>
								Transform Your Ideas into Custom Embroidered / Printed Masterpieces<br />
							</h1>
							<p
								class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none"
							>
								From personal designs to business branding, bring your vision to life with our
								premium embroidery / printing services. No minimum orders, <b
									>with special pricing for bulk quantities</b
								>, no design experience needed - just pure creativity.
							</p>
						...
						>
							...
							>
								<div class="group relative cursor-pointer">
									...
									/>
									<div
										class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-gray-900/10 transition duration-300 ring-inset group-hover:shadow-xl group-hover:ring-gray-900/20"
									></div>
								</div>
							</div>
