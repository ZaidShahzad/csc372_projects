...
<div class="mt-24 flex min-h-full">
	...
	>
		<div class="mx-auto w-full max-w-sm py-24 lg:w-96">
			<div>
				...
				<p class="mt-2 text-sm/6 text-gray-500">
					...
					<a href="/auth/sign-up" class="font-semibold text-green-600 hover:text-green-500"
						>Create one</a
					>
				</p>
			</div>
			...
			<div class="mt-10">
				...
				<!-- <div class="mt-10">
					...
					<div class="mt-6 grid grid-cols-2 gap-4">
						<a
							href="#"
							class="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 shadow-sm ring-gray-300 ring-inset hover:bg-gray-50 focus-visible:ring-transparent"
						>
